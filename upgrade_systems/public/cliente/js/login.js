...
function registrarIntentoFallido(mensajeServidor) {
    ...
    if (intentos >= 3) {
        ...
        msgBox.innerHTML = `<strong>Acceso Denegado:</strong> ${mensajeServidor}<br><span style="font-size:0.8rem; font-weight:600; color:var(--accent-red);">Intentos restantes: ${3 - intentos}</span>`;
        msgBox.style.display = "block";
    }
}
